...
public class CommonUtil {
	...
	public static void main(String args[]) {
		// 获取接口访问凭证
		String accessToken = CommonUtil.getToken("wxba3104e1b4b8246a", "47785df1654f86e5f7b5045c2c20a859").getAccessToken();
		System.out.println(accessToken);
		String getopenidurl = "https://api.weixin.qq.com/cgi-bin/user/info/batchget?access_token=ACCESS_TOKEN";
